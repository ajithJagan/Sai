...
export const partner = [
  { routeLink: 'dashboard', icon: 'fal fa-home', label: 'Dashboard', exact: true, },
  { routeLink: 'talents', icon: 'fal fa-box-open', label: 'Talents', exact: true, },
  ...
  { routeLink: 'invoice', icon: 'fal fa-file-invoice-dollar', label: 'Invoice', exact: false, },
...
export const owner = [
  ...
  { routeLink: 'dashboard', icon: 'fal fa-book-open', label: 'Learn & Grow', exact: true },
...
export const superadmin = [
  ...
  { routeLink: 'clients', icon: 'fal fa-users', label: 'Clients', exact: true },
